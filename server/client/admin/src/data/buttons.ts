...
const supportedHtmlElements: ButtonsSection = {
  title: 'The <code>.btn</code> classes are designed to be used with <code>&lt;button&gt;</code>, <code>&lt;a&gt;</code> and <code>&lt;input&gt;</code> elements.',
  buttons: [{
    theme: 'primary',
    type: 'link',
    label: 'External link',
...
const buttons: Buttons = [
  [
    ...
    },
    {
      ...
      sections: [
        defaultSquareButtons,
        elevationOptionsSquareButtons
      ]
    },
    {
      title: 'Pill buttons',

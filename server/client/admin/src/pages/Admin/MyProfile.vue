<script setup lang="ts">
  ...
  import {
    PortletComponent, PortletBody, PortletHeadLabel, PortletHead, PortletHeadToolbar
                ...
                <div class="kt-section kt-section--first">
                  <div class="kt-section__body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <FormDropdown v-model="form.role" :options="roles" :value="form.role" />
                      </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="kt-section">
                  <div class="kt-section__body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <FormInput v-model="form.first_name" :id="'first_name'"/>
                      </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="kt-section">
                  <div class="kt-section__body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <FormInput v-model="form.password_confirmation" :id="'password_confirmation'"/>
                      </div>
                    </div>
                  </div>
                </div>

<script setup lang="ts">
  ...
  const {
    externalNavigation: externalNavigationAccordionId,
    internalNavigation: internalNavigationAccordionId,
  ...
  <div :class="block">
    <AccordionContent @onAccordionChange="onAccordionChangeHandler">
      <AccordionItem
        ...
        :id="externalNavigationAccordionId"
      >
      ...
      <AccordionItem
        ...
        :id="internalNavigationAccordionId"
      >
        <div :class="element('content').value">
          <FormInput
          ...
          <FormInput
            id="external-url"
            v-model="externalUrl"
            :label="t('navigation.external-url')"
            name="External url"
          />
          <DashButton
            size="sm"

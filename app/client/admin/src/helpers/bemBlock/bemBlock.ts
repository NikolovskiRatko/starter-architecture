...
type CreateBEMClasses = (baseClass: string, element?: string, conditionalClasses?: Ref<ClassObject>) => ComputedRef<ClassObject>;

type UseBEMBuilder = (
  baseClass: string,
  baseClassModifiers?: Ref<ClassObject>
) => [ComputedRef<ClassObject>, (element: string, elementConditionalClasses?: Ref<ClassObject>) => ComputedRef<ClassObject>];
...
export const useBEMBuilder: UseBEMBuilder = (baseClass, baseClassModifiers) => {
  ...
  return [
    ...
    (element, elementModifiers) => createBEMClasses(baseClass, element, elementModifiers),
  ];
};
